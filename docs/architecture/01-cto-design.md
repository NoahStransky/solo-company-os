...
1. **P0** — Registry + State（基础CRUD）
2. **P0** — Scheduler（Agent 调度）
3. **P1** — Dashboard CLI（看板）
4. **P1** — Dependency Manager（依赖）
5. **P2** — Web Dashboard（可视化）
6. **P2** — Agent Prompt 模板系统
